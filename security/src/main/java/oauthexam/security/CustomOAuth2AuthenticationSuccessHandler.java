...
import oauthexam.service.SocialLoginInfoService;
import oauthexam.service.UserService;
...
//            우리 서비스에 알맞게 정보를 채워줘야겠죠?
            ...
            // 세션에 SecurityContext 저장 (이게 없으면 redirect 후 인증이 날아감)
